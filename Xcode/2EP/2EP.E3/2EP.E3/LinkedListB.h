...
#ifndef LinkedListB_LinkedListB_h
#define LinkedListB_LinkedListB_h
...
namespace vcn {
    ...
    protected:
        ...
        public:
            Iterator(LinkedListB<T> * _adata, int _aposition)
    ...
    public:
        ...
        friend std::ostream & operator <<(std::ostream &, LinkedListB<Tn> &);
    ...
    template  <class T>
    LinkedListB<T>::~LinkedListB()
    {
        this->clear();
    }
    
    template  <class T>
    Node<T> * LinkedListB<T>::first()
    {
        return this->_first;
    }
    
    template  <class T>
    int LinkedListB<T>::size()
    {
        return this->_size;
    }
    
    template  <class T>
    bool LinkedListB<T>::empty()
    {
        return this->_size == 0;
    }
     ...
     */
    template  <class T>
    void LinkedListB<T>::insert(T element, int position)
    {
    ...
    template  <class T>
    void LinkedListB<T>::insert(Node<T> * newnode, int position)
    {
    ...
    template  <class T>
    void LinkedListB<T>::insertFront(T element)
    {
        this->insert(element, 0);
    }
    
    template  <class T>
    void LinkedListB<T>::insertFront(Node<T> * node)
    {
        this->insert(node, 0);
    }
    
    template  <class T>
    void LinkedListB<T>::insertBack(T element)
    {
        this->insert(element, this->_size);
    }
    
    template  <class T>
    void LinkedListB<T>::insertBack(Node<T> * node)
    {
        this->insert(node, this->_size);
    }
    
    template  <class T>
    Node<T> * LinkedListB<T>::remove(int position)
    {
    ...
    template  <class T>
    Node<T> *  LinkedListB<T>::removeFront()
    {
        return this->remove(0);
    }
    
    template  <class T>
    Node<T> *  LinkedListB<T>::removeBack()
    {
        return this->remove(this->_size - 1);
    }
    
    template  <class T>
    Node<T> *  LinkedListB<T>::remove(Node<T> * node)
    {
        return this->remove( this->at(node) );
    }
    
    template  <class T>
    void LinkedListB<T>::clear()
    {
    ...
    template  <class T>
    Node<T> *  LinkedListB<T>::at(int position)
    {
        /* Cuando la lista está vacía o position es inválida */
        if (this->empty() || (position < 0 || position >= this->_size )) {
            return nullptr;
    ...
    template  <class T>
    int LinkedListB<T>::at(Node<T> * node)
    {
    ...
    template <class T>
    std::ostream & operator <<(std::ostream & os, LinkedListB<T> & list)
    {
        for (auto node : list )
        {
            os << node << std::endl;
    ...
    template  <class T>
    Node<T> * LinkedListB<T>::operator [](const int position)
    {
        return this->at(position);
    }
    
    template  <class T>
    bool LinkedListB<T>::search(T element)
    {
        return ( this->searchAndReturnPosition(element) != -1 );
    }
    
    template  <class T>
    int LinkedListB<T>::searchAndReturnPosition(T element)
    {
        /* Cuando la lista está vacía */
    ...
    template  <class T>
    Node<T> * LinkedListB<T>::searchAndReturnNode(T element)
    {
        /* Cuando la lista está vacía */
